...
var services = [
  {
    ...
    imgSrc2:
      "https://wphix.com/template/kindspa-prv/assets/img/slider/slider-04.png",
    title: "Anti-Ageing Treatments",
    description1:
      "Bellaviva offers personalized anti-aging treatments combining medical-grade products, advanced technology, and customized plans for rejuvenated skin.",
    description2:
  ...
  },
  {
    ...
    imgSrc2:
      "https://wphix.com/template/kindspa-prv/assets/img/slider/slider-05.jpg",
    title: "Skin Lightening",
    description1:
      "At Bellaviva, our skin lightening treatment reduces dark spots and hyper-pigmentation, revealing a brighter and more even complexion. Personalized and effective with medical-grade products and advanced technology.",
    description2:
  ...
  },
  {
    ...
    title: "Facial Peels",
    description1:
      "At Bellaviva, our facial peels enhance skin appearance, texture, and tone using medical-grade products and advanced technology. Personalized treatment for optimal results.",
    description2:
  ...
  },
  {
    ...
    title: "Hydra Facial",
    description1:
      "Bellaviva offers Hydra Facial—a non-invasive, multi-step treatment for immediate, radiant skin results.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Bellaviva offers personalized pigmentation treatments using advanced technology and medical-grade products to reduce dark spots and uneven skin tone. Achieve a radiant complexion with our customized treatment plans.",
    description2:
  ...
  },
  {
    ...
    title: "Acne/Rosacea",
    description1:
      "Effective acne and rosacea treatments at Bellaviva Skin Clinic. Clearer skin and improved complexion. Visit us for personalized care.",
    description2:
...

  {
    ...
    description1:
      "Indulge in our holistic massage therapy at Bellaviva Skin Clinic, where skilled therapists combine relaxation techniques and natural remedies to rejuvenate your body and mind, promoting overall wellness and inner harmony.",
    description2:
      "Indulge in our holistic massage therapy at Bellaviva Skin Clinic, where skilled therapists combine relaxation techniques and natural remedies to rejuvenate your body and mind, promoting overall wellness and inner harmony.",
    link: "holistic.html",
...

  {
    ...
    description1:
      "Bellaviva offers safe and effective laser hair removal for both men and women, targeting hair follicles with advanced technology. Achieve long-lasting results with minimal discomfort and downtime.",
    description2:
  ...
  },
  {
    ...
    description1:
      "At Bellaviva, we provide safe and effective mole and wart removal services using advanced technology. Our experienced team ensures minimal scarring and offers proper aftercare for optimal healing.",
    description2:
  ...
  },
  {
    ...
    description1:
      "At Bellaviva, our advanced laser technology safely removes or fades tattoos of any size, color, or location. Personalized treatment plans ensure optimal results.",
    description2:
  ...
  },
  {
    ...
    imgSrc2:
      "https://wphix.com/template/kindspa-prv/assets/img/slider/slider-05.png",
    title: "Hair Loss Treatment",
    description1:
      "Bellaviva offers personalized hair loss treatments using advanced technology and medical-grade products to promote hair growth and reduce hair loss.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Bellaviva offers hair transplant procedures with advanced techniques like FUE and FUT for natural-looking results. Personalized treatment plans and minimal recovery time.",
    description2:
...

  {
    ...
    title: "Botox & Fillers",
    description1:
      "Bellaviva provides Botox and dermal filler treatments to reduce wrinkles and enhance facial contours. Personalized treatment plans for your desired results.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Bellaviva offers the vampire facelift, a non-surgical PRP therapy using the patient's blood plasma to rejuvenate the skin. Enhance your appearance with our experienced team.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Bellaviva offers jawline shaping using dissolvable threads for a non-surgical lift and sculpting of the jawline and lower face. Customized treatments by experienced professionals. Minimally invasive with minimal downtime and discomfort.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Bellaviva: Lift and contour cheeks and eyebrows with dissolvable threads. Non-surgical, minimally invasive treatment for a defined and youthful appearance.",
    description2:
  ...
  },
  {
    ...
    description1:
      "Discover rejuvenating treatments at Bellaviva Skin Clinic. Achieve youthful, radiant skin through advanced techniques and personalized care.",
    description2:
...
function generateServiceItems(category) {
  ...
  filteredServices.forEach(function (service) {
    ...
    var serviceItemContent = `
		<a href="${service.link}" class="service-link" data-img1="${service.imgSrc1}" data-img2="${service.imgSrc2}" data-title="${service.title}" data-description1="${service.description1}" data-description2="${service.description2}" data-tableData1="${service.tableData1}" data-tableData2="${service.tableData2}">
